...
CHAPTERS_MAP = {
    "1": "What Is The Shell? - Introdução ao prompt, bash e comandos básicos de navegação inicial. [The_Linux_Command_Line.pdf:p3]",
    "2": "Navigation - Comandos essenciais para navegar em diretórios: pwd, cd, ls. [The_Linux_Command_Line.pdf:p11]",
    "3": "Exploring The System - Investigando o sistema operacional com menos, file e o mapeamento Linux. [The_Linux_Command_Line.pdf:p22]",
    "4": "Manipulating Files And Directories - Criação e destruição com cp, mv, mkdir, rm. [The_Linux_Command_Line.pdf:p34]",
    "5": "Working With Commands - Diferenciação de tipos usando type, which, help e man. [The_Linux_Command_Line.pdf:p45]"
}
